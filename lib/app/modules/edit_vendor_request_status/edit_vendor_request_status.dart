...
class EditVendorRequestStatus extends StatefulWidget {
  const EditVendorRequestStatus({super.key});

  @override
  State<EditVendorRequestStatus> createState() => _EditVendorRequestStatusState();
}

class _EditVendorRequestStatusState extends State<EditVendorRequestStatus> {
  @override
  final EditVendorRequestStatusController controller = Get.put(EditVendorRequestStatusController());
...
// Status Selection Dialog
  void _showStatusDialog(BuildContext context, EditVendorRequestStatusController controller) {
    showDialog(
      context: context,
      builder: (context) {
        return AlertDialog(
...
// Submit Form Logic
  Future<void> _submitForm(EditVendorRequestStatusController controller) async {
